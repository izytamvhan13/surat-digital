    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        <form id="validation-form" method="POST">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <label for="catatan_validasi" class="block text-sm font-medium text-slate-700">Catatan (Opsional)</label>
                    <textarea name="catatan_validasi" id="catatan_validasi" rows="3" class="mt-1 w-full px-3 py-2 border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500"></textarea>
                </div>
            </div>
